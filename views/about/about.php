...
<body>
    <div class="box">
        <img src="assets/img/elon.jpg" alt="" class="box-img">
        <h1>David Shekhovtsov</h1>
        ...
        <ul>
            <li><a href="/Verstka/index.php"><i class="fa fa-arrow-circle-o-left" ariahidden="true"></i></a></li>
        </ul>
    </div>
</body>
